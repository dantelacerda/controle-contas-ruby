class ClientesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @cliente.update(cliente_params)
        format.html { redirect_to clientes_url, notice: 'Cliente atualizado com sucesso!' }
  ...
  private
    ...
    def cliente_params
      params.require(:cliente).permit(:nome, :tipocliente, :data, :cpfcnpj, :nomefantasia)
    end
