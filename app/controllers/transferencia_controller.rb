class TransferenciaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contum.save
        format.html { redirect_to @contum, notice: 'Conta criada com sucesso!' }
  ...
  private
    ...
    def contum_params
      params.require(:contum).permit(:nome, :numero, :saldo, :tipoconta, :datacriacao, :situacao, :conta_id)
    end
end
